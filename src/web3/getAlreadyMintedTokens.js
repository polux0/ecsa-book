...
const getAlreadyMintedTokenIds = async () => { // Notice the position of "async"
    ...
    const provider = new ethers.AlchemyProvider("sepolia", "-tMMu3AHudsbSzy1OJNFuhoiFCgHLKwE");
    ...
    try {
        ...
        const alreadyMintedTokenIds = await nftContract.getAlreadyMintedTokenIds();
        
    
        // You can process the fetched token IDs here, e.g.:
        alreadyMintedTokenIds.forEach(tokenId => {
            console.log('Number: ', Number(tokenId))
            // Maybe you want to hide or modify some elements related to the already minted tokens.
        ...
        console.log('Already minted token IDs:', alreadyMintedTokenIds);
    }
    catch (error) {
        console.log('An error occurred:', error);
    }
}
export {getAlreadyMintedTokenIds}
